...
public class LoginController {
    ...
    public AccountToken login(@RequestBody Account account) {
        ...
        AccountToken accountToken = new AccountToken(account1.getId(),account1.getUsername(),account1.getPassword(), account1.getAvatar(), account1.getAddress(), account1.getPhone(),token, account1.getRoles());
        return accountToken;
